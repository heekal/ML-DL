...
| 5 | Matrices, Part 1 | `Matrices_Part_1.ipynb` |
| 6 | Matrices, Part 2 | `Matrices_Part_2.ipynb` |
| 7 | Matrix Applications | `Matrix_Applications.ipynb` |
| 8 | Matrix Inverse | `Matrix_Inverse.ipynb` |
| 9 | Orthogonal Matrices and QR Decomposition | `Orthogonal_Matrices_and_QR_Decomposition.ipynb` |
| 10 | Row Reduction and LU Decomposition | `Row_Reduction_dan_LU_Decomposition.ipynb` |
| 11 | General Linear Models and Least Squares | `General_Linear_Models_dan_Least_Squares.ipynb` |
| 12 | Least Squares Applications | `Least_Squares_Applications.ipynb` |
| 13 | Eigendecomposition | `Eigendecomposition.ipynb` |
| 14 | Singular Value Decomposition | `Singular_Value_Decomposition.ipynb` |
| 15 | Eigendecomposition and SVD Applications | `Eigendecomposition_and_SVD_Applications.ipynb` |
| 16 | Python Tutorial | `Python_Tutorial.ipynb` |
...
├── Vectors_Part_1.ipynb
├── Vectors_Part_2.ipynb
├── Vector_Applications.ipynb
├── Matrices_Part_1.ipynb
├── Matrices_Part_2.ipynb
